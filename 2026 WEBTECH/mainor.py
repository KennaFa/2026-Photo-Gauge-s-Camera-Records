...
def initialize_database():
    """Copy local DB to TMP_DIR if not exists and create table if missing."""
...
def migrate_database():
    """Ensure 'description' and 'photo' columns exist."""
    conn = create_connection()
    cursor = conn.cursor()
    ...
    if "description" not in columns:
        cursor.execute("ALTER TABLE cameras ADD COLUMN description TEXT DEFAULT ''")
